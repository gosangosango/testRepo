 ...
 * @since 2018. 06. 25.
 */
public class GetLotOpr {
    public GetLotOprOut get(GetLotOprIn input) throws Exception {
    
        SummaryInfo summaryInfo = getSummaryInfo(input);
        
        GetLotOprOut output = new GetLotOprOut();
        ...
        if ( input.getOperCode() != null && !"".equals(input.getOperCode())) {
            ...
            if ( input.isInvMatFlag() ) {
                ...
                output.setList(getBFMatList(input));
    ...
    private SummaryInfo getSummaryInfo(GetLotOprIn input) throws Exception {
    ...
    private List<InputBFMat> getBFMatList(GetLotOprIn input) throws Exception {

...
public interface Dml {
	 ...
	 * @throws Exception
	 */
	<T> T select(T data, SelectOptions options) throws Exception;
	 ...
	 * @throws Exception
	 */
	<T> T selectWithLock(T data, SelectOptions options) throws Exception;
	 ...
	 * @throws Exception
	 */
	<T> T select(Class<T> clazz, Object pkCondition, SelectOptions options) throws Exception;
	 ...
	 * @throws Exception
	 */
	<T> T selectWithLock(Class<T> clazz, Object pkCondition, SelectOptions options) throws Exception;
	 ...
	 * @throws Exception
	 */
	<T> T select(String tableName, Object pkCondition, SelectOptions options, Class<T> requiredType) throws Exception;
	 ...
	 * @throws Exception
	 */
	<T> T selectWithLock(String tableName, Object pkCondition, SelectOptions options, Class<T> requiredType) throws Exception;
